...
export const HighlightsSection = ({
  ...
  return (
    <div>
      ...
      <div
        ref={ref}
        className="h-[215vh] sm:h-[210vh] md:h-[220vh] xl:h-[200vh] py-20 md:py-40 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
      >
        <motion.div
          style={{
            rotateX,
